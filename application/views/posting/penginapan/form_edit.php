                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Hotel</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">Gambar Gambar Hotel</div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#kab').change(function() {
                    ...
                    $.ajax({
                        url: "<?= base_url('postingan/get_ubah_kecamatan'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                ...
                function get_data_edit() {
                    ...
                    $.ajax({
                        url: "<?= base_url('postingan/get_data_edit_penginapan'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
